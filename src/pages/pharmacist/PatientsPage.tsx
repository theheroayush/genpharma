...
export default function PatientsPage() {
  ...
  const [prescriptions] = useLocalStorage<Prescription[]>(
    "gp_prescriptions",
    [],
  );
  ...
  const patientPrescriptions = useMemo(() => {
    ...
    return prescriptions.filter((rx) =>
      selectedPatient.prescriptionIds.includes(rx.id),
    );
  ...
  const adherenceBar = (a: number) => {
    const color =
      a >= 80 ? "bg-green-500" : a >= 60 ? "bg-amber-500" : "bg-red-500";
    return (
  ...
  return (
    <>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              ...
              {patients.filter((p) => p.active).length} active
            </p>
          </div>
              ...
              <CardContent className="pt-4">
                <div className="flex items-start gap-3">
                  <Avatar className="h-12 w-12">
                    <AvatarFallback
                      className={`text-sm ${patient.active ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`}
                    >
                      {patient.initials}
                    </AvatarFallback>
                  </Avatar>
                ...
                <div className="mt-3 space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span
                      className={`font-semibold ${adherenceColor(patient.adherence)}`}
                    >
                      {patient.adherence}%
                    </span>
                  </div>
      ...
      <Dialog
        ...
        onOpenChange={(v) => !v && setSelectedPatient(null)}
      >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {selectedPatient.phone} · {selectedPatient.language}
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Card>
                  <CardContent className="pt-4 text-center">
                    ...
                    <p
                      className={`text-2xl font-bold ${adherenceColor(selectedPatient.adherence)}`}
                    >
                ...
                <Card>
                  <CardContent className="pt-4 text-center">
                    ...
                    <p className="text-2xl font-bold">
                      {selectedPatient.prescriptionIds.length}
                    </p>
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    setSelectedPatient(null);
                    setShowMessage(selectedPatient);
                  }}
                >
      ...
      <Dialog open={!!showCall} onOpenChange={(v) => !v && setShowCall(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>📞 Calling {showCall?.name}</DialogTitle>
          </DialogHeader>
      ...
      <Dialog
        open={!!showMessage}
        onOpenChange={(v) => !v && setShowMessage(null)}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>💬 Message {showMessage?.name}</DialogTitle>
          </DialogHeader>
          <div className="space-y-3">
            ...
            {[
              ...
              <Button
                ...
                onClick={() => {
                  setShowMessage(null);
                  toast({
                    title: `Message sent to ${showMessage?.name}`,
                    description: msg,
                  });
                }}
              >
