              ...
              <CardContent className="pt-4">
                ...
                <div className="mt-3 flex items-center justify-between">
                  ...
                  <div className="flex gap-1">
                    <Button variant="outline" size="icon" aria-label={`Call ${patient.name}`} className="h-7 w-7" onClick={(e) => { e.stopPropagation(); setShowCall(patient); }}>
                      <Phone className="h-3 w-3" />
                    </Button>
                    <Button variant="outline" size="icon" aria-label={`Message ${patient.name}`} className="h-7 w-7" onClick={(e) => { e.stopPropagation(); setShowMessage(patient); }}>
