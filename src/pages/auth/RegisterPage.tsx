...
import { Eye, EyeOff, AlertCircle, Loader2, CheckCircle, UserPlus } from "lucide-react";
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
                <div className="text-center mb-8">
                    <Link to="/" className="inline-flex items-center gap-2.5 mb-4">
                        ...
                        <span className="font-display text-2xl font-bold text-foreground tracking-tight">GenPharma</span>
                    </Link>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="e.g. Rajesh Kumar" required className="mt-1.5 rounded-xl" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <Input id="phone" type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+91 98765 43210" className="mt-1.5 rounded-xl" />
                            </div>
                            <div>
                                <Label htmlFor="password" className="text-sm font-medium">Password</Label>
                                <div className="relative mt-1.5">
                                    <Input id="password" type={showPw ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min 6 characters" required className="rounded-xl pr-10" />
                                    <button
                                        type="button"
